...
export declare function CheckOpenSearchProps(propsObject: OpenSearchProps | any): void;
export declare function getOpenSearchApiName(propsObject: OpenSearchProps): "es" | "aoss";
export declare function getOpenSearchEndpoint(propsObject: OpenSearchProps): string;
